...
/**
 * Experimental, flow-based PRO report template. It intentionally lives beside
 * the existing fixed-coordinate renderer so production downloads stay intact.
 */
...
.page { width: 210mm; height: 297mm; padding: 13mm 14mm 25mm; position: relative; display: flex; flex-direction: column; background: var(--paper); break-after: page; page-break-after: always; overflow: hidden; }

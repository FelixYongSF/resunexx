...
export const resumeRulebook: ResumeRule[] = [
  ...
  rule("IMP-001", "impactAchievements", "Show outcomes", "Bullets should communicate results, not just assigned duties.", "Critical", 2, "outcome", "Revise responsibilities into contribution statements.", "Improved onboarding checklist, reducing setup questions by 20%."),
